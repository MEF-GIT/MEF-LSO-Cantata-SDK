# Mplify-LSO-Cantata-SDK - Kylie Release

## Download Link

Download the entire repository by clicking
[here](https://github.com/MEF-GIT/MEF-LSO-Cantata-SDK/releases/download/kylie/Mplify-LSO-Cantata-SDK-kylie.zip)
...
This repository contains the Mplify LSO Cantata SDK. It includes API definitions
...
MCP Server code added for every Seller side API.
...
to
[LSO Cantata SDK Home Page](https://wiki.mplify.net/display/CESG/LSO+Cantata+SDK)
on the Mplify WIKI.
...
- `generated`
  ...
  - `schema/preStandard` - pre-standard product schemas and documentation 
